    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-remove').click(function () {
                // $(this) 可以获取当前点击的 移除 按钮的 jQuery 对象
                // closet() 方法可以获取到匹配选择器的第一个祖先元素，在这里就是当前点击的 移除 按钮之上的 <tr> 标签
                // data('id') 方法可以获取到我们之前设置的 data-id 属性的值，也就是对应SKU id
            ...
            $('#select-all').change(function () {
                ...
                // 获取所有 name=select 并且不带有 disable 属性的勾选框
