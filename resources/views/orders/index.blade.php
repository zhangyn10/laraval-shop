                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($order->items as $index => $item)
                                            <tr>
                                                <td class="product-info">
                                                    ...
                                                    <div>
                                                        <span class="product-title">
                                                            <a target="_blank" href="{{ route('products.show', [$item->product_id]) }}"></a>
                                                        </span>
                                                ...
                                                @if($index === 0)
                                                    <td class="text-center total-amount" rowspan="{{ count($order->items) }}">¥{{ $order->total_amount }}</td>
                                                    ...
                                                    <td class="text-center" rowspan="{{ count($order->items) }}"><a
                                                                href="{{ route('orders.show', ['order' => $order->id]) }}" class="btn btn-primary btn-sm">查看订单</a></td>
                                                @endif
                                            </tr>
                                        @endforeach
                                    </table>
