                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="sales_and_reviews">
                                ...
                                <div class="rating" title="评分 {{ $product->rating }}">评分 <span class="count">{{ str_repeat('☆', 5- floor($product->rating)) }}</span></div>
                            </div>
                            <div class="skus">
                                <label>选择</label>
                                <div class="btn-group" data-toggle="buttons">
                                    @foreach($product->skus as $sku)
                                        <label title="{{ $sku->description }}" class="btn btn-default sku-btn" data-price="{{ $sku->price }}" data-stock="{{ $sku->stock }}" data-toggle="tooltip" data-placement="bottom">
                            ...
                            <div class="buttons">
                                ...
                                @endif
                                <button class="btn btn-primary btn-add-to-card">加入购物车</button>
                            </div>
                        </div>
                    </div>
                    <div class="product-detail">
                        <ul class="nav nav-abs" role="tablist">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-favor').click(function () {
                // 发起一个ajax post请求，请求url通过后段的route()生成
